...
class CheckCommission extends Command
{
    ...
    {
        if ((int)config('daoboard.commission_auto_check_enable', 1)) {
    ...
    {
        $level = 3;
        if ((int)config('daoboard.commission_distribution_enable', 0)) {
            $commissionShareLevels = [
                0 => (int)config('daoboard.commission_distribution_l1'),
                1 => (int)config('daoboard.commission_distribution_l2'),
                2 => (int)config('daoboard.commission_distribution_l3')
            ];
        } else {
            $commissionShareLevels = [
                0 => 100
