...
return [
    ...
    "agreements" => [
        ...
        "content" => "感谢您使用云上部落！我们将依据<a href='https://xn--w3r021g.top/user-agreement.html'>《用户服务协议》</a>和<a href='https://xn--yfrz36isthva.com/privacy-policy.html'>《隐私政策》</a>来帮助您了解我们在收集、使用、存储和共享您个人信息的情况以及您享有的相关权利。<br><br>1、您可以通过查看《用户服务协议》和《隐私政策》来了解我们可能收集、使用的您的个人信息情况；<br><br>2、基于您的明示授权，我们可能调用您的重要设备权限。我们将在首次调用时逐项询问您是否允许使用该权限，您有权拒绝或取消授权；<br><br>3、我们会采取业界先进的安全措施保护您的信息安全；<br><br>4、您可以查询、更正、删除、撤回授权您的个人信息，我们也提供账户注销的渠道。<br><br>",
         # 服务协议url
        "serviceLink" => "https://xn--w3r021g.top/user-agreement.html",
        # 隐私政策url
        "privacyLink" => "https://xn--w3r021g.top/privacy-policy.html",
    ],
    ...
    "noticeList" => [
        [
            "show" => true,  # 开关
            "title" => "邀请返利10%",
            "content" => "每邀请一名朋友并成为我们的会员，您将获得邀请佣金奖励(佣金比例10%)，若朋友在萌通加速消费100元，您则可获得返利20元。此返利可用于购买套餐或提现！【快来和我们一起赚钱吧！】",
