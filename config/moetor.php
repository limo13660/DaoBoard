...
return [
	...
	'crispId' => '',	//crisp客服id，可空
	'inviteUrl' => 'https://cloud.ydgw.us/#/register?code=',	//邀请链接前缀
	'subUrlSource' => 1,    # 订阅链接来源：1=从面板获取，2=从当前app检测后的api做拼接，3=将打包地址中的多个api拼接后做检测
	...
	'agreements' => [
		'show' => true,
		'title' => '个人信息保护提示',
		'content' => '感谢您使用云上部落！我们将依据<a href="https://xn--fhqrm578kvuk.com/user-agreement.html">《服务协议》</a>来帮助您了解我们在收集、使用、存储和共享您个人信息的情况以及您享有的相关权利。<br><br>1、您可以通过查看《服务协议》来了解我们可能收集、使用的您的个人信息情况；<br><br>2、基于您的明示授权，我们可能调用您的重要设备权限。我们将在首次调用时逐项询问您是否允许使用该权限，您有权拒绝或取消授权；<br><br>3、我们会采取业界先进的安全措施保护您的信息安全；<br><br>4、您可以查询、更正、删除、撤回授权您的个人信息，我们也提供账户注销的渠道。<br><br>',
		'serviceLink' => 'https://xn--fhqrm578kvuk.com/user-agreement.html',
		'privacyLink' => 'https://xn--fhqrm578kvuk.com/user-agreement.html'
	],
	'noticeList' => [
		[
			'show' => false,
			'title' => '邀请返利10%',
			'content' => '每邀请一名朋友并成为我们的会员，您将获得邀请佣金奖励(佣金比例10%)，若朋友在云上部落消费100元，您则可获得返利20元。此返利可用于购买套餐或提现！【快来和我们一起赚钱吧！】',
			'negative' => '',
			'position' => '',
			'positionLink' => ''
		],
		[
			'show' => true,
			'title' => '云上部落永久官网',
			'content' => '由于政策原因，导致域名很容易被封，这是不可控因素。为了防止失联，请牢记并收藏云上部落永久地址发布页【 云上部落.com 】',
			'negative' => '我已知晓',
			'position' => '收藏官网',
			'positionLink' => 'https://xn--fhqrm578kvuk.com'
		],
        [
            "show" => true,
            "title" => "加入官方TG频道",
